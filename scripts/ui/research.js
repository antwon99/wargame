import { createHudDrawerController, syncHudDrawerHeader } from './hud.js';

/**
 * Toggle the research drawer open, creating a controller if necessary.
 * @param {object} game live game singleton.
 * @param {boolean} [forceOpen] explicit open/close state (defaults to open).
 */
