const { buildUiAdapter } = require('./uiAdapter.js');
const { createRegistryHelpers } = require('./registry.js');
 ...
 */
function createImperialMandateState({
    adapter = {},
    registry = [],
    calendar = {},
    favorHelpers = {},
    rebelSystem = {},
    tutorialCallouts = null,
    runtimeGlobal: _runtimeGlobal = (typeof window !== 'undefined' ? window : globalThis)
} = {}) {
    void _runtimeGlobal;
    const RebelSystem = rebelSystem || {};
    const TutorialCallouts = tutorialCallouts;
    const { getMandateBlueprint } = createRegistryHelpers(registry);
...
module.exports = { createImperialMandateState };
