...
- **`scripts/imperialMandatesCore.js`** contains the state machine, recurrence logic, and data transforms. It accepts an adapter so tests can instantiate the core without touching DOM or audio globals.
